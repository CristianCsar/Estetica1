...
import Est_Productos.Est_Productos1;




public class ModeloEst1 {
private static  DataSource origenDatos;
	
	public ModeloEst1(DataSource origenDatos) {
		ModeloEst1.origenDatos= origenDatos;
        }
	
	public List<Est_Productos1> getProductos() throws Exception{
		List<Est_Productos1> productos= new ArrayList<>();
		...
		//establecer la conexion 
				...
				while(miResultset.next()) {
					...
					Est_Productos1 temProd = new Est_Productos1(id,producto,precio, tiempo);
					productos.add(temProd);
				}
				return productos;
}

	public void agregarNuevoProducto1(Est_Productos1 nuevoProducto) throws Exception {
	...
	public static Est_Productos1 getProducto(String id_articulo) {
		Est_Productos1 elProducto = null;
		Connection miConexion = null;
		PreparedStatement miStatement = null;
		ResultSet miResultset = null;
		...
		if(miResultset.next()) {
			...
			elProducto = new Est_Productos1(id,producto,precio, tiempo);
	...
	public void actualizarProducto1(Est_Productos1 productoActualizado) throws Exception{
	...
	public static void eliminarProducto1(int idArticulo)throws Exception {
		Connection miConexion=null;
		PreparedStatement miStatement = null;
