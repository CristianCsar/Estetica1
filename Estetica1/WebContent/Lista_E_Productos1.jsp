...
<c:url var="linkTemp" value="Controlador_E_P1" >
<c:param name="instruccion" value="cargar"></c:param>
<c:param name="idarticulo" value="${temProd.id}"></c:param>
</c:url>

<c:url var="linkTempEliminar" value="Controlador_E_P1" >
...
<td Class="filas"><a href="${linkTemp}">Agregar</a>&nbsp;&nbsp;</td>
</tr>
...
<input type="button" value="Agendar Cita" Class="buttons" onclick="window.location.href='inserta_producto.jsp'">
</div>
</body>
</html>