 ...
 */
@WebServlet("/Controlador_E_P1")
public class Controlador_E_P1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
private ModeloEst1 esteticaproductos;
	...
	public void init() throws ServletException {
		...
		super.init();
		try {
			esteticaproductos = new ModeloEst1(miPool);
		}catch(Exception e){
	...
	private void actualizaProductos(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//crear un objeto de tipo producto con la info del formulario
				Est_Productos1 productoActualizado1 = new Est_Productos1(IdArticulo,Descripcion,Precio,Duracion);
					
		//actualizar la BD con la info del objeto producto
				esteticaproductos.actualizarProducto1(productoActualizado1);
...
*/
	private void agregarProductos(HttpServletRequest request, HttpServletResponse response) {
		...
		// crear un objeto de tipo producto
			Est_Productos1 nuevoProducto = new Est_Productos1(IdArticulo,Descripcion,Precio,Duracion);
		
		// enviar el objeto al modelo
			try {
				esteticaproductos.agregarNuevoProducto1(nuevoProducto);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	private void obtenerProductos(HttpServletRequest request, HttpServletResponse response) {
		...
		//enviar request a la pagina jsp                               // apunta a la pagina jsp que vamos a usar
			RequestDispatcher miDispatcher = request.getRequestDispatcher("/Lista_E_Productos1.jsp");
